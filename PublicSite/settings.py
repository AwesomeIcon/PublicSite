# Django settings for PublicSite project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'publicsite',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '@3q1nb1m(t!*%y8s!3s)bfl-pi4b1p*g%5mb%i^)imjfcrju@w'
